 ...
 * @LastEditTime: 2020-10-23 10:54:08
...
<template>
    <div>
        ...
        <div class="container">
            <el-form :model="MailFrom" status-icon ref="SendEmail" :rules="rules" style="width: 500px; height: 300px; margin: 12px auto auto">
                ...
                <el-form-item>
                    <el-button type="primary" @click="submit('SendEmail')">发送</el-button>
