 ...
 * @LastEditTime: 2020-10-23 10:13:11
...
<template>
    <div>
        ...
        <div class="container">
            <el-form :model="Mail" ref="SendEmail" style="width: 500px; height: 300px; margin: 0 auto">
                ...
                <el-form-item>
                    <el-button type="success" @click="submit" round ma>发送</el-button>
